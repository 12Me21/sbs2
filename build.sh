...
cat sbs2-markup/_build.js fill.js entity.js request.js draw.js view.js Views/settings.js Views/chat.js Views/page.js navigate.js main.js > resource/_build.js
