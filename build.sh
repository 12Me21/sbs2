...
cat sbs2-markup/_build.js fill.js entity.js request.js draw.js view.js Views/settings.js Views/chat.js Views/page.js Views/search.js Views/images.js sidebar.js navigate.js main.js > resource/_build.js
